...
class MRIToyDataset(Dataset):
    def __init__(self, root_dir='../Data4YuansGroup/Data/', existing_load_path=existing_load_path):
        # Check if the existing dataset should be loaded
        ...
        image_size=128
        max_display=5
        # Otherwise, proceed with dataset creation
        self.data = []
        self.text = []
        displayed = 0
