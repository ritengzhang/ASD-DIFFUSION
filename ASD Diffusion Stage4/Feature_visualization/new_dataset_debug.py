...
# df.to_csv('processed_abcd_ksad01.csv', index=False)
# print("Processed DataFrame saved to 'processed_abcd_ksad01.csv'.")
...
possible_col = ["sex", "interview_age", "label", "ksads_14_402_p"]  # Replace with your columns
